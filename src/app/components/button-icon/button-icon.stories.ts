...
const meta: Meta<ButtonIconComponent> = {
  ...
  argTypes: {
    ...
    ariaLabel: {
      control: 'text',
      description: 'Etiqueta accesible para lectores de pantalla (obligatoria)',
    },
  },
  args: {
    hierarchy: 'primary',
...
export const Playground: Story = {
  name: '⚡ Playground',
  args: { hierarchy: 'primary', variant: 'default', mode: 'default' },
  parameters: {
    docs: {
      description: {
        story:
          'Story interactiva. Usa los **Controls** para cambiar jerarquía, estado y modo. El botón responde a hover, click y focus en el Canvas.',
      },
    },
  },
  play: async ({ canvasElement, step }) => {
    ...
    await step('Render — botón visible y habilitado', async () => {
...
export const PlaygroundDisabledDemo: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step('Verificar que está deshabilitado', async () => {
